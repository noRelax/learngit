...
public class TenPayUtils {
	...
	public static final String WX_APP_ID = "wx82b154174f0387b8";

	public static final String NOTIFY_URL = "/tenpay/recveive.html";
	/** 商户号 */
	public static final String WX_PARTNER_ID = "1440434502";
	/** 接口链接 */
	...
	public static final String key = "138b19ed05b9ce6cb0740211c150bd36";

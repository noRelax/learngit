...
public interface IUserGroupService {
	...
	List<UserGroupModel> queryQTForList(String keyword, Integer page,
			Integer rows) throws Exception;

	List<UserGroupModel> queryHTForList(Integer groupType, String keyword,
	...
	List<UserGroupModel> queryHTByList(Integer groupType, int page, int rows)
			throws BusinessException;

	List<UserGroupModel> queryQTByList(Integer groupType, int page, int rows)
			throws BusinessException;
	...
	int deleteAllUserGroup(Integer groupId, Integer[] USER_IDS)
			throws BusinessException;

	int deleteAppAllUserGroup(Integer groupId, Integer[] USER_IDS)
			throws BusinessException;
}

 ...
 * @Description:TODO
 * @author:张钟武
 * @date:2017年2月13日 上午10:34:46
 * @version:
 */
@Table(name = "t_app_user")
public class AppUserModel extends BaseEntity implements Serializable {
	public AppUserModel(){
		
	}

	public AppUserModel(String userAccount){
		this.userAccount = userAccount;
	}
	/**
	 * 
	 */
	private static final long serialVersionUID = -3240592831888371631L;

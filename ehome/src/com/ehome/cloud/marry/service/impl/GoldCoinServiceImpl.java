...
public class GoldCoinServiceImpl extends BaseService<GoldCoinModel> implements IGoldCoinService {
    ...
    public Map<String, Integer> thumpUpAddGoldCoins(Integer thumpUpAppUserId, Integer photoId) {
        ...
        Integer toAppUserAddNum = 0; // 被点赞人增加金币
    ...
    public Map<String, Integer> commentAddGoldCoins(Integer commentAppUserId, Integer photoId) {
        ...
        toAppUserAddNum = this.jedisForTimeslimit("marry:beiCommentAppUserId:login:id:", beiCommentAppUserId, 7, 1);
    ...
    public Integer saveGoldCoinModel(Integer goldCoinsChangeType, Integer setGoldCoinsChangeDerection, Integer appUserId) {
        ...
        Integer goldCoinNum = 0;
        synchronized (appUserId) {
            entity.setAppUserId(appUserId);
            entity = appMarryService.selectOne(entity);
            if (entity != null) {
                goldCoinNum = entity.getGoldCoins() == null ? 0 : entity.getGoldCoins();
                entity.setGoldCoins(goldCoinNum + number);
                appMarryService.updateNotNull(entity);
            }
        }
        return number;
    }
    ...
    public Map<String, Object> chatAtherExpendGoldCoins(String fromUserId, String toUserId) {
        ...
        List<Integer> list = goldCoinMapper.queryChartRecord(fromUserId, toUserId);
        if (CollectionUtils.isEmpty(list)) {
            map.put("isFirstChat", 1);
        } else {
            map.put("isFirstChat", 0);
        }
        return map;
    }
}

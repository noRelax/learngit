...
public class AppMarryPhotoServiceImpl extends BaseService<MarryPhoto> implements IAppMarryPhotoService {
    ...
    public void publishPhoto(Integer appUserId, Integer pictureId, Integer sourceDevice, String pictureUrl, String idea, String location,
        ...
        entity = appMarryMemmberService.selectOne(entity);
        //保存照片实体
        ...
        //更新婚恋用户照片数
        Integer photoNum = entity.getPhotoNum() == null ? 0 : entity.getPhotoNum();
        photoNum++;
        entity.setPhotoNum(photoNum);
        appMarryMemmberService.updateNotNull(entity);
    }
    ...
    public void deletePhoto(Integer photoId) throws Exception {
        ...
        //更新婚恋用户信息
        MarryMemberModel entity = new MarryMemberModel();
        entity.setAppUserId(marryPhoto.getAppUserId());
        entity = appMarryMemmberService.selectOne(entity);
        Integer photoNum = entity.getPhotoNum() == null ? 0 : entity.getPhotoNum();
        photoNum++;
        entity.setPhotoNum(photoNum);
        ...
        if (CollectionUtils.isNotEmpty(commentList)) {
            ...
            Integer commentNum = entity.getCommentNum() == null ? 0 : entity.getCommentNum();
            entity.setCommentNum(commentNum - commentList.size());
        }
        //删除点赞记录
        Condition condition = new Condition(MarryThumpUpModel.class);
        condition.createCriteria().andEqualTo("photoId", photoId);
        List<MarryThumpUpModel> thumpList = appMarryThumpUpService.selectByCondition(condition);
        if(CollectionUtils.isNotEmpty(thumpList)){
            appMarryThumpUpService.deleteByCondition(condition);
            Integer thumpNum = entity.getThumbUpNum() == null ? 0 : entity.getThumbUpNum();
            entity.setThumbUpNum(thumpNum - thumpList.size());
        }
        appMarryMemmberService.updateNotNull(entity);
    }
    ...
    public Integer addComment(Integer appUserId, Integer photoId, String comment, Integer sourceDevice) throws Exception {
        ...
        entity.setAppUserId(marryPhoto.getAppUserId());
        entity = appMarryMemmberService.selectOne(entity);
        commentNum = entity.getCommentNum() == null ? 0 : entity.getCommentNum();
        commentNum++;
    ...
    public Map<String, Integer> thumpUp(Integer photoId, Integer appUserId, Integer sourceDevice) throws Exception {
        ...
        entity.setAppUserId(marryPhoto.getAppUserId());
        entity = appMarryMemmberService.selectOne(entity);
        thumpUpNum = entity.getThumbUpNum() == null ? 0 : entity.getThumbUpNum();
        thumpUpNum++;
        entity.setThumbUpNum(thumpUpNum);
        appMarryMemmberService.updateNotNull(entity);

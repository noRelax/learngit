 ...
 * 个推管理类
  */
public class GetuiUtilForZJ {
	private final static Logger logger = LoggerFactory
			.getLogger(GetuiUtilForZJ.class);
	public static final String defaultValue = "";
	//  透传
	@Deprecated
	public static TransmissionTemplate transmissionTemplateDemo() {
	    TransmissionTemplate template = new TransmissionTemplate();
	    template.setAppId(Constants.APPIDZJ);
	    template.setAppkey(Constants.APPKEYZJ);
	...
	public void testNotify(){
		...
		IGtPush push = new IGtPush(Constants.HOST, Constants.APPKEYZJ, Constants.MASTERSECRETZJ);
		// 通知透传模板
		...
		target1.setAppId(Constants.APPIDZJ);
//		target1.setClientId(CID1);
		 target1.setAlias("1234");
		target2.setAppId(Constants.APPIDZJ);
//		target2.setClientId(CID2);
	...
	public void testTransmission(){
		// 配置返回每个用户返回用户状态，可选
		System.setProperty("gexin.rp.sdk.pushlist.needDetails", "true");
		// IGtPush push = new IGtPush(Const.HOST, Const.APPKEYZJ,
		// Const.MASTERSECRETZJ);

		IGtPush push = new IGtPush(Constants.APPKEYZJ, Constants.MASTERSECRETZJ, true);
		// 通知透传模板
		...
		target.setAppId(Constants.APPIDZJ);

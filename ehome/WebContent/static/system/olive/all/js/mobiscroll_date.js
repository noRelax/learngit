                ...
                that.tap($('.dwb-s span', dw), function () {
                    if (that.hide(false, 'set') !== false) {
                        setTimeout(function(){
                            ...
                            var startTime = parseInt(startTimeArr[0],10) + parseInt(startTimeArr[1],10);
                            var endTime = parseInt(endTimeArr[0],10) + parseInt(endTimeArr[1],10);
                            /*if (startTimeArr != undefined && endTimeArr != undefined) {

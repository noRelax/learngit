            ...
            init: function(flag) {
                ...
                var oTable = $('#home-list')
                    .dataTable({
                        ...
                        "sAjaxSource": "../member/home/queryMemberHome",
                        "aoColumnDefs": [{
                        ...
                        "fnServerData": getHomeGridData
                    });

                var list = jQuery('table[id=home-list]');
                //选择事件
                ...
                function handlerUpdateClick(e) {
    				...
    				parent.layer.open({
    				    ...
    				    title: '修改',
    				    area: ['700px', '600px'],
    				    content:'../member/home/update-member-home.html?pkId='+pkId,
    				    end:function(){
    				    	oTable.fnDraw();
    				    }
    				});
    				...
    				parent.layer.open({
    				    content: '确定要删除吗?'
    					  ...
    					  ,yes: function(index, layero){
    							jQuery.post('../member/home/deleteMemberHome',{'pkId':pkId},function(data){
                ...
                //表格回调函数
                function getHomeGridData(url, aoData, fnCallback) {
